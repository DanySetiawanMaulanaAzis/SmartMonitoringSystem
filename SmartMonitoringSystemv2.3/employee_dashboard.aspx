<%@ Page MasterPageFile="~/Site.Master" Title="Smart Monitoring System" Language="C#" AutoEventWireup="true" CodeBehind="employee_dashboard.aspx.cs" Inherits="SmartMonitoringSystemv2._3.employee_dashboard" Async="true" %>
    ...
    <script>
        ...
        function deleteWorkLog(workLogId) {
            if (confirm("Are you sure you want to delete this work log?")) {
                $.ajax({
                    type: "POST",
                    url: "employee_dashboard.aspx/DeleteWorkLog",
                    data: JSON.stringify({ workLogId: workLogId }),
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function () {
        ...
        $(document).ready(function () {
            ...
            const efficiencyScore = '<%= ViewState["EfficiencyScore"] %>';
            ...
            $('#efficiencyScore').text(efficiencyScore);
