<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="SmartMonitoringSystemv2._3.login" ValidateRequest="false" %>
    ...
    <form id="form1" runat="server" class="custom-login">
        <div class="custom-login-card">
            ...
            <div class="card-body">
                ...
                <asp:Label ID="lblMessage" runat="server" ForeColor="Red" CssClass="custom-error-message" />
